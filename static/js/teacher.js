...
function dotClass(status) {
  return ({ engaged:'dot-engaged', writing:'dot-writing', sleeping:'dot-sleeping', away:'dot-away',
...
function updateSummary() {
  ...
  sumEngaged.textContent = all.filter(s => s.status === 'engaged' || s.status === 'writing').length;
